...
```python
# AUTOFOUNDER-BACKEND/app/agents/coder/schema.py
...
```python
# AUTOFOUNDER-BACKEND/app/agents/coder/graph.py
...
# AUTOFOUNDER-BACKEND/app/agents/coder/routers.py
...
```python
# AUTOFOUNDER-BACKEND/app/agents/coder/tools.py
...
```jinja2
{# AUTOFOUNDER-BACKEND/app/agents/coder/prompts/scaffold_repo.j2 #}
...
```jinja2
{# AUTOFOUNDER-BACKEND/app/agents/coder/prompts/generate_frontend.j2 #}
...
```jinja2
{# AUTOFOUNDER-BACKEND/app/agents/coder/prompts/generate_backend.j2 #}
...
```jinja2
{# AUTOFOUNDER-BACKEND/app/agents/coder/prompts/generate_db_layer.j2 #}
...
```jinja2
{# AUTOFOUNDER-BACKEND/app/agents/coder/prompts/generate_integrations.j2 #}
...
```jinja2
{# AUTOFOUNDER-BACKEND/app/agents/coder/prompts/generate_admin_panel.j2 #}
...
```jinja2
{# AUTOFOUNDER-BACKEND/app/agents/coder/prompts/generate_ci_cd.j2 #}
...
```jinja2
{# AUTOFOUNDER-BACKEND/app/agents/coder/prompts/generate_tests.j2 #}
...
```jinja2
{# AUTOFOUNDER-BACKEND/app/agents/coder/prompts/lint_self_correct.j2 #}
...
```python
# AUTOFOUNDER-BACKEND/app/agents/coder/nodes/error_handler.py
...
```python
# AUTOFOUNDER-BACKEND/app/agents/coder/utils/retry.py
...
```python
# AUTOFOUNDER-BACKEND/app/agents/coder/utils/llm_parse.py
...
```python
# AUTOFOUNDER-BACKEND/app/agents/coder/utils/workspace.py
...
```python
# AUTOFOUNDER-BACKEND/app/agents/coder/utils/sla.py
