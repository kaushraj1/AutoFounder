...
| 11 | [11-asit-guardrails-pipeline-plan.md](11-asit-guardrails-pipeline-plan.md) | **Asit Piri** (Purnima co-owns Output+Monitoring) | Guardrails & Governance — 6-stage pipeline wrapping every agent call | AF-046 | `feature/guardrails-pipeline` |
