"""Jinja2 prompt loader for the Architect Agent (AF-040).
...
def render(template_name: str, **variables: Any) -> str:
    ...
    Args:
        template_name: filename without extension, e.g. "extract_requirements"
    ...
    Raises:
        jinja2.UndefinedError: if a required variable is missing in the template.
