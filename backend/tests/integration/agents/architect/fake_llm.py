...
_RESPONSES: list[tuple[str, dict[str, Any]]] = [
    ...
    ("FR-001", {
        "requirements": [
            {"id": "FR-001", "kind": "FR", "description": "Users can sign up", "priority": "P0"},
            {
                "id": "FR-002",
                "kind": "FR",
            ...
            {"id": "FR-005", "kind": "FR", "description": "Invite team members", "priority": "P1"},
            {"id": "NFR-001", "kind": "NFR", "description": "API p99 < 150ms", "priority": "P0"},
            {"id": "NFR-002", "kind": "NFR", "description": "AES-256 at rest", "priority": "P0"},
        ],
        "use_cases": [
            {
                "id": "UC-001",
